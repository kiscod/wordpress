        ...
        <ul class="top_image_container">
            <li>
                <?php if (blackwell_get_option('blackwell_topimage') != '') { ?>
                    <a href="<?php if (blackwell_get_option('blackwell_top_imagelink') != '') {
                ...
                <div class="container">
                    <?php if (blackwell_get_option('blackwell_top_imageheading') != '') { ?>
                        <h1><a href="<?php if (blackwell_get_option('blackwell_top_imagelink') != '') {
                                echo esc_url(blackwell_get_option('blackwell_top_imagelink'));
                ...
                <div class="grid_24">
                    <div class="feature_content">
                        ...
                        <div class="grid_8 alpha">
                            <div class="feature_content_inner first animated"
                                 style="-webkit-animation-delay: .2s; -moz-animation-delay: .2s;  -o-animation-delay: .2s;  -ms-animation-delay: .2s;">
                                <!-- *** Three column Box 2 *** -->
                                ...
                                <?php if (blackwell_get_option('blackwell_feature_head1') != '') { ?>
                                    ...
                                    ?>">
                                        <h2><?php echo esc_attr(blackwell_get_option('blackwell_feature_head1')); ?></h2>
                                    </a>
                                <?php } else { ?>
                                    <a href="#"><h2><?php _e('Font Awesome Icons', 'blackwell'); ?></h2></a>
                                <?php }
                                if (blackwell_get_option('blackwell_feature_desc1') != '') { ?>
                        ...
                        <div class="grid_8 alpha">
                            <div class="feature_content_inner second animated"
                                 style="-webkit-animation-delay: .5s; -moz-animation-delay: .5s; -o-animation-delay: .5s; -ms-animation-delay: .5s;">
                                <!-- *** Three column Box 2 *** -->
                                <p class="font_icon"><i class="<?php
                                ...
                                <?php if (blackwell_get_option('blackwell_feature_head2') != '') { ?>
                                    ...
                                    ?>">
                                        <h2><?php echo esc_attr(blackwell_get_option('blackwell_feature_head2')); ?></h2>
                                    </a>
                                <?php } else { ?>
                                    <a href="#"><h2><?php _e('your embed videos', 'blackwell'); ?></h2></a>
                                <?php }
                                if (blackwell_get_option('blackwell_feature_desc2') != '') { ?>
                        ...
                        <div class="grid_8 alpha">
                            <div class="feature_content_inner third animated"
                                 style="-webkit-animation-delay: .9s; -moz-animation-delay: .9s; -o-animation-delay: .9s;  -ms-animation-delay: .9s;">
                                <!-- *** Three column Box 3 *** -->
                                <p class="font_icon"><i class="<?php
                                ...
                                <?php if (blackwell_get_option('blackwell_feature_head3') != '') { ?>
                                    ...
                                    ?>">
                                        <h2><?php echo esc_attr(blackwell_get_option('blackwell_feature_head3')); ?></h2>
                                    </a>
                                <?php } else { ?>
                                    <a href="#"><h2><?php _e('Completely responsive', 'blackwell'); ?></h2></a>
                                <?php }
                                if (blackwell_get_option('blackwell_feature_desc3') != '') { ?>
